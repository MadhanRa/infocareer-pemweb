...
if (isset($_POST['register'])) {
  ...
  if (mysqli_num_rows($sql_cek) > 0) {
    ...
    $query = "INSERT INTO perusahaan (`idPerush`, `namaPerush`, `produk`, `alamatPerush`, `telpFaxPerush`, `emailPerush`, `namaCp`, `telpCp`, `regTime`, `tentangPerush`, `passwordPerush`, `flag`) VALUES ('', $nama,$produk, $alamatPerush, $telpFaxPerush, $email, $namaCp, $telpCp, CURRENT_TIMESTAMP, $tentangPerush, $password, 1)";
